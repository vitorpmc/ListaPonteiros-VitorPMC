...
d) Expressão inválida, pois x é uma variável do tipo inteiro, para a qual a atribuição de expressões com o operador "*" antecedendo uma dada variável, que corresponde ao operador de derreferência, não são compatíveis.
*/